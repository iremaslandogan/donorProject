    ...
    public partial class MyFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDonationTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDonationTypes_DonationTypes_DonationTypeId",
                        column: x => x.DonationTypeId,
                        principalTable: "DonationTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserDonationTypes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDonationTypes_DonationTypeId",
                table: "UserDonationTypes",
                column: "DonationTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserDonationTypes_UserId",
                table: "UserDonationTypes",
                column: "UserId");
